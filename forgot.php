...
{ 
	...
	$email = $_POST['mail'];
	$q=mysqli_query($con,"select * from little_register where u_mail='".$email."' ") or die(mysql_error());
	$p=mysqli_num_rows($q);
	if($p>0) 
	{
		...
		$body             = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
			...
			<div style='width:370px; height:203px; position:relative; float:left; margin-left:50px;  background:url(http://139.59.27.207/logo_1.png)' ></div>
...
padding:50px; font-family:Arial Black, sans-serif; font-size:20px; font-weight:bold;'>WE RESPECT TALENT</div>
		...
		<p style='padding-left:40px'>Your littleshows password is ".$forgoter_pass." <a href='http://139.59.27.207/dubsmash/login.php'>click here</a> to login again.</p>
		<br><br>
		...
		<div style='width:250px; height:auto; padding-top:9px; min-height:20px; position:relative; float:left; color:#000; font-family:Arial, sans-serif; font-weight:bold; font-size:22px;'>139.59.27.207</div>
		...
		<div style='width:190px; padding-left:25px; height:auto; padding-top:2px; padding-bottom:5px; min-height:10px; margin:0; position:relative; float:left; color:#FFF;  font-family:Arial, sans-serif; font-size:14px; margin-bottom:5px; background:url(http://139.59.27.207/social/f.png) left top no-repeat;' >www.facebook.com/littleshows</div>

		<div style='width:190px; padding-left:25px; height:auto; padding-top:2px; padding-bottom:5px; min-height:10px; margin:0; position:relative; float:left; color:#FFF; font-family:Arial, sans-serif; font-size:14px; margin-bottom:5px; background:url(http://139.59.27.207/social/p.png) left top no-repeat;' >www.pintrest.com/littleshows</div>

		<div style='width:190px; padding-left:25px; height:auto; padding-top:2px; padding-bottom:5px; min-height:10px; margin:0; position:relative; float:left; color:#FFF;  font-family:Arial, sans-serif; font-size:14px; margin-bottom:5px; background:url(http://139.59.27.207/social/g.png) left top no-repeat;' >plus.google.com/+LittesShows</div>

		<div style='width:190px; padding-left:25px; height:auto; padding-top:2px; padding-bottom:5px; min-height:10px; margin:0; position:relative; float:left; color:#FFF;  font-family:Arial, sans-serif; font-size:14px; margin-bottom:5px; background:url(http://139.59.27.207/social/t.png) left top no-repeat;' >www.twitter.com/littleshows</div>

		<div style='width:190px; padding-left:25px; height:auto; padding-top:2px; padding-bottom:5px; min-height:10px; margin:0; position:relative; float:left; color:#FFF; font-family:Arial, sans-serif; font-size:14px; margin-bottom:5px; background:url(http://139.59.27.207/social/yt.png) left top no-repeat;' >www.youtube.com/thelittleshows</div>
