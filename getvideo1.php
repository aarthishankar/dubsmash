...
while($row_select_movie=mysqli_fetch_assoc($result_select_movie)){
	...
	$result_take_video_owner=mysqli_query($con,$take_video_owner);
	$row_take_video_owner=mysqli_fetch_array($result_take_video_owner);
	...
	?>
		...
		<span class="pull-left"><img src="//139.59.27.207/profile/<?php echo $littleID?>/001.png" style="width:20px; height:20px; margin-left:5px; margin-top:5px; border-radius:50px;"/>
