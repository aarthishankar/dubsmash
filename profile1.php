...
if(!empty($str)){
	...
	if(isset($_SESSION['u_id'])){
		...
		$query2 = mysqli_query($con,$check_contest) or die(mysql_error());
...
if(isset($_SESSION['u_id'])){
	...
	$ownership = ($v_result_check_ownership>0 ? 1 : 0);
}
...
<!--     <img src="http://139.59.27.207/profile/little_186521/001.png" style="width:200px; height:200px; border-radius:300px;" />
-->
