...
if(!isset($_GET['mov_id'])){
	...
	$result_ran=mysqli_query($con,$sql);
	$row_ran=mysqli_fetch_array($result_ran);
	$movi= $row_ran['movieID'];
	header("Location: http//139.59.27.207/dubsmash/share_video.php?mov_id=$movi");
	exit(0);
}
?>
...
$actual_link = "http://139.59.27.207/dubsmash/share_video.php?mov_id=$mov_ide";
?>
...
<meta property="og:image" content="http://139.59.27.207/dubsmash/asset/image/ison.png" />
...
$("#share_video").click(function(e) {
		...
		FB.ui({
method: 'feed',
link: 'http://139.59.27.207/dubsmash/share_video.php?mov_id='+id_prof,
