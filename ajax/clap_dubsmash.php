...
mysql_query($update_clap);

$get_owner="select competitorID from dubs_contestmovie where movieID='$movieID'";
$result_get_owner=mysql_query($get_owner);
$row_get_owner=mysql_fetch_array($result_get_owner);
...
mysql_query($update_overall_clap);	
